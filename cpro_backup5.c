...
int init_file1(FILE **fp, CUS **);
int init_file2(FILE **fp, PRO **);
int init_file3(FILE **fp, HIS **);
...
int init_file1(FILE **fp, CUS **cus){
...
int init_file2(FILE **fp, PRO **pro){

}

int init_file3(FILE **fp, HIS **his){
